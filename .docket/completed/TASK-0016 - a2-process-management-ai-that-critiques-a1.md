...
acceptance-criteria:
  ...
  - Each proposal has target, evidence, confidence, and an actionable diff
  - A2 sees A1 prompt as a file it can reason about (not hardcoded)
  - A2 is invokable via skill
---
